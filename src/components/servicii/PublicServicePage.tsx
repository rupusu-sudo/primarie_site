...
import type { PublicServicePageConfig, ServiceAccordionEntry } from "@/data/publicServicePages";
...
type PublicServicePageProps = {
  config: PublicServicePageConfig;
};
...
export const PublicServicePage = ({ config }: PublicServicePageProps) => {
