  ...
  return (
    ...
    >
      <main className="max-w-6xl mx-auto">
        ...
        {/* Ghișeul.ro Banner */}
        <div className="p-4 mb-8 bg-green-50 border-green-200">
          <a 
        ...
        <section aria-labelledby="servicii-disponibile">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {servicii.map((serviciu) => (
              <div key={serviciu.id} className="overflow-hidden card-hover">
                {/* Colored Header */}
        ...
        {/* Info Card */}
        <div className="p-6 mt-10 bg-primary/5 border-primary/20">
