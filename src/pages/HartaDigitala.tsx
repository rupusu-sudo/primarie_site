    ...
    <div className="container mx-auto p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[650px]">
        ...
        <div className="lg:col-span-1 h-full overflow-y-auto">
          {isEditorMode ? (
             <div className="h-full border-orange-200 border-2 shadow-md">
            ...
            <div className="h-full border-l-4 border-l-blue-500">
          ...
          ) : <div className="h-full flex items-center justify-center p-6 text-gray-400 border-dashed">Selectează o parcelă.</div>}
        </div>
      </div>
    </div>
  );
