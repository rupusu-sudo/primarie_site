      ...
      <div className="bg-[#F8FAFC] min-h-screen py-10 md:py-20 font-sans selection:bg-blue-100">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="mb-12 sm:mb-16 border-none shadow-[0_20px_50px_rgba(0,0,0,0.05)] rounded-2xl sm:rounded-[3rem] overflow-hidden bg-white/80 backdrop-blur-xl ring-1 ring-slate-100">
            ...
            <div className="space-y-12">
              {loading ? (
                ...
                return (
                  ...
                  >
                    <div className={`border-none shadow-[0_10px_40px_rgba(0,0,0,0.03)] rounded-2xl sm:rounded-[3rem] bg-white transition-all hover:shadow-xl ${officialSupport ? 'ring-2 ring-blue-600/20' : ''}`}>
